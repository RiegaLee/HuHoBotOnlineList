...
public final class BuiltInOnlineListCommand extends BaseCommand {
    private final BiConsumer<Object, String> handler;

    public BuiltInOnlineListCommand(BiConsumer<Object, String> handler) {
        this.handler = handler;
    }

    @Commands(command = "在线列表", describe = "生成服务器在线玩家列表，可选页码")
    public void onlineList(Object groupMessageEvent, String arguments) {
        handler.accept(groupMessageEvent, arguments == null ? "" : arguments);
    }
}
